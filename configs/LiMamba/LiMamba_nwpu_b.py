...
work_dir = 'work_dirs/LiMamba_nwpu_b_patch=8,batch=8,5path+qshift'

data_root = 'NWPU-RESISC45'
code_root = 'datainfo/NWPU/'
...
vis_backends = [dict(type='LocalVisBackend'),
                # dict(type='WandbVisBackend', init_kwargs=dict(project='LiMamba', group='NWPU', name='LiMamba_aid_b'))
                ]
