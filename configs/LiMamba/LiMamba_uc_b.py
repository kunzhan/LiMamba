...
_base_ = [
    '_base_/LiMamba_default_runtime.py',
    '_base_/datasets/uc_bs64_pil_resize_autoaug.py',
    # '_base_/datasets/uc_dataset.py',
    '_base_/schedules/uc_schedule.py',
]

work_dir = 'work_dirs/LiMamba_uc_b_patch=8,batch=8,5path+qshift'

data_root = 'UCMerced_LandUse/Images'
code_root = 'datainfo/uc/'
...
vis_backends = [dict(type='LocalVisBackend'),
                # dict(type='WandbVisBackend', init_kwargs=dict(project='LiMamba', group='UC', name='LiMamba_uc_b'))
                ]
